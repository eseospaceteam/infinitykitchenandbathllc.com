...
//
// Sixteen rules, all deliberately DIFFERENT from the heuristic spam scoring used
...
function isBlockedText(t, opts) {
  ...
  if (!sellsSearch && (isSeoSolicitation(t, opts) || isLeadGenPitch(t) || isSpecWebsitePitch(t) || isSpecAiAgentPitch(t) || isSiteFeedbackTease(t))) return true;
